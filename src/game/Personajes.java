...
public abstract class Personajes extends Animado {
	...
	protected void colisionesEnemigo(Animado animado){
		...
		} else if (animado instanceof Gohan) {
			addVitalidad(-Gohan.DAMAGE);

		} else if (animado instanceof Krillin) {
			addVitalidad(-Krillin.DAMAGE);

		} else if (animado instanceof PoderGokuDebil) {
			animado.remover();
			addVitalidad(-PoderGokuDebil.DAMAGE);

		} else if (animado instanceof PoderGohan) {
			animado.remover();
			addVitalidad(-PoderGohan.DAMAGE);

		} else if (animado instanceof PoderKrillin) {
			animado.remover();
			addVitalidad(-PoderKrillin.DAMAGE);
